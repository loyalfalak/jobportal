	...
	<script language = "JavaScript" >
		function deletejob(id){
			if(confirm("Do your really want to delete this record?")){
				window.location.href= 'delete_applied_jobs.php?id='+id;
			}	
		}
	</script>
</head>
	...
	<div class="wrapper">
    	...
    	<?php include(TEMPLATE.'job_seeker_leftbar.php');?>
			...
			<div class="jobseeker_middle" style="margin-left: 10px;">
				<form name="apply_now" method="post" action="" enctype="multipart/form-data">
					<table border="1px;" style="margin-top: 10px;" width="700px;" class="tb">
						...
						<tr>
							...
							<td>
								<center>
									<a href="view_apply_now_more_details.php?id=<?php echo $row['pjid'];?>" style="text-decoration: none">View Details</a>
								</center>
								<br>
								<center>
