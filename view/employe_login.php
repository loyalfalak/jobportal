	...
	<div class="wrapper">
	    ...
	    <div class="content1">
	  		<div class="client_login1">
                ...
                <a href="employe_registration.php" class="btnn" style="padding:8px;border-radius: 6px;margin-left:180px;color:#fff;height: 20px;text-decoration: none;">Create Your Account Now</a>
			</div>
			<div class="client_login">
	            <form name="login" action="" method="post">
	                <h2 style="margin-left: 20px;margin-top: 5px;color:#006990;">Employer Login</h2>
	                <table>
	                    <tr>
