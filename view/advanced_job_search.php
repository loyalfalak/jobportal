	...
	<div class="wrapper">
			...
			<?php include(TEMPLATE.'menubar.php');?>
				<div class="content">
					...
					<div class="jobseeker_middle" style="margin-left: 0px;margin-top: 10px;">
	     				<div class="jobseeker_leftbar_title" style="margin-left: 10px;">
	  	 					 <h2>Search Jobs</h2>
	  					</div>
							...
							<table style="margin-top: 50px;" cellspacing="10px;">
								...
								<tr>
									...
									<td>	
								     ...
								     <td><input type="submit" name="submit" value="Search" class="btn7"/></td>
							    </tr> 
							</table>
						</form>
					</div>	
				 ...
				 ?>		
					<table border="1px;" style="margin-top: 10px;" width="690px;" class="tb">
						<tr>
						...
						<tr>
							...
							<td>
								<center>
									<a href="view_advanced_job_search_more_details.php?id=<?php echo $row['pjid'];?>" style="text-decoration: none">View Details</a>
								</center>
							</td>
						</tr>
						<?php } ?>
