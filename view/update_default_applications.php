    	...
    	<?php include(TEMPLATE.'job_seeker_leftbar.php');?>
			...
			<div class="jobseeker_middle">
				...
				<form name="default_applications" method="post" action="" enctype="multipart/form-data">
					<?php $data = mysql_fetch_array($viewdata); ?>
					<table style="margin-top: 50px;" cellspacing="10px;">
						...
						<tr>
							...
							<td><textarea name="description" cols="25" rows="6"><?php echo $data['description'];?></textarea></td>
						</tr>
						<tr>
							<td align="center" colspan="2"><input type="submit" name="submit" value="Update" class="btn7" /></td>
						</tr>
					</table>
				</form>
	  	 	</div>
