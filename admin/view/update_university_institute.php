		...
		<?php include(ADDTEMPLATE.'admin_menu.php');?>
			<div class="login_container">
				...
				<form action="" method="post" enctype="multipart/form-data">
					<center><h3 class="heading">Update University Institute</h3></center>
					<center>
					<?php $row=mysql_fetch_array($result); ?>
					<table>
						<tr>
							<td>University Institute</td>		   	    	
							<td><input type="text" name="university_institute" value="<?php echo $row['university_institude_details']; ?>" /></td>
						</tr>
						<tr>       
