		...
		<div class="login_container">
			<center>
				<form name="category" method="post" style="height: auto; width: 900px;">
					<center><h3><b>View Function</b></h3></center>
					<a href="add_function.php">Add Function</a>
					<table align="center" border="1" style="margin-top: 10px;">
					 ...
					 <?php while($row = mysql_fetch_array($viewdata)){?>		
						<tr>
							...
							<td><a href="update_function.php?uid=<?php echo $row['function_id'];?>">Update</a>
								<a href="delete_function.php?did=<?php echo $row['function_id'];?>">Delete</a>
							</td>
						</tr>
					<?php }?>
					</table>  
