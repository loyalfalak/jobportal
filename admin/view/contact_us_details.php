...
<head>
	...
	<body>
		...
		<div class="login_container">
			<br>
				<center><h3 class="heading">Contact Us Image</h3></center>
			<br>
			<form method="post" style="height: 555px; width: 900">
				<table width="500px" height="300px;" style="margin-left: 660px;">
					<tr>
						...
						<td><textarea name="contact_us" id='contact_us'> <?php echo $row['contact_us_data'];?></textarea></td>
						<td>
						<input type="hidden" name="id" value="<?php echo $row['contact_us_details_id'];?>" />
						</td>
						<?php }?>
					</tr>
					<tr>
			...
			<script type="text/javascript" >
			  ...
			  <form method="post" enctype="multipart/form-data" action="">	
				   <table width="400px" height="400px" style="margin-top: -450px;margin-left: 250px;">
					    <tr>
						   <td>
						   		<img src="../images/<?php echo $row1['contact_us_images'];?>" height = "100px" width = "100px"/>
						   </td>
			   				<td>
