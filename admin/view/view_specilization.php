			...
			<div class="login_container">
				<center>
					<form name="category" method="post" style="height: 500px; width: 900px;">
						<center><h3><b>View Specilization</b></h3></center>
							<a href="add_specilization.php">Add Specilization</a>
						<table align="center" border="1" style="margin-top: 10px;">
							...
							<tr>
								<td><?php echo $row['specilization_details'];?></td>
								<td>
									<a href="update_specilization.php?uid=<?php echo $row['specilization_id'];?>">Update</a>
									<a href="delete_specilization.php?did=<?php echo $row['specilization_id'];?>">Delete</a>
								</td>
							</tr>
							<?php }?>
						</table>  
